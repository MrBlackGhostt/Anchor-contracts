...
impl<'info> ClaimStack<'info> {
    pub fn claim(ctx: Context<ClaimStack>, amount: u64) -> Result<()> {
        ...
        let signer_seeds = &[b"vault", signer.key.as_ref(), &[bump]];
